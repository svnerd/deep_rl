...
class FCNet(nn.Module):
    def __init__(self, input_size, output_size, hidden_sizes, output_func=_dummy_func):
...
class FCNetInjectX(nn.Module):
    def __init__(self, input_size, output_size, hidden_sizes, layer_x, size_x, output_func=_dummy_func):
